...
class DataCenter(object):
    ...
    def __init__(self, config,reqId):
    ...
    def load_unseen_dataSet(self, dataSet='NPInter5', adj_lists=None, node_map=None, feat_data=None):
        # print(self.config)
        feat_file =os.path.join('src','data','input',self.reqId+'_'+dataSet+ '_graphsage_dataset/' + dataSet + '_feats' + '.txt')
    ...
    def load_dataSet(self, dataSet='RPI2241', embedding_type=None):
        ...
        if embedding_type == None:
            feat_file =os.path.join('src',dataSet+ '_graphsage_dataset/'+ dataSet +'_feats.txt')
            interaction_file =os.path.join('src',dataSet+ '_graphsage_dataset/'+ dataSet +'_total_interactions_seq_list.txt')
            train_interaction_file =os.path.join('src',dataSet+ '_graphsage_dataset/'+ dataSet +'_graphsage_train_interactions.txt')
            test_interaction_file =os.path.join('src',dataSet+ '_graphsage_dataset/'+ dataSet +'_graphsage_test_interactions.txt')
        else:
            feat_file =os.path.join('src',dataSet+ '_' + embedding_type + '_graphsage_dataset/' + dataSet +'_feats.txt')
            interaction_file =os.path.join('src',dataSet+ '_' + embedding_type + '_graphsage_dataset/' + dataSet +'_total_interactions_seq_list.txt')
            train_interaction_file =os.path.join('src',dataSet+ '_' + embedding_type + '_graphsage_dataset/' + dataSet +'_graphsage_train_interactions.txt')
            test_interaction_file =os.path.join('src',dataSet+ '_' + embedding_type + '_graphsage_dataset/' + dataSet +'_graphsage_test_interactions.txt')


        # print("feat_file: ", feat_file)
        # print("interaction_file: ", interaction_file)
        # print("train_interaction_file: ", train_interaction_file)
        # print("test_interaction_file: ", test_interaction_file)
